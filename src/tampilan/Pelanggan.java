...
protected void datatable() {
    ...
    try {
        String sql = "SELECT * FROM pelanggan WHERE id_pign LIKE '%" + cariitem + "%' OR nmpign LIKE '%" + cariitem + "%' ORDER BY id_pign ASC";
    ...
    try {
        String sql = "UPDATE pelanggan SET nmplgn=?, jenis=?, telepon=?, alamat=? " +
                     "WHERE id=?";
